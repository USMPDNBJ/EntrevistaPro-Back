import { createCourseService, deleteCourseService, getAllCourseService, getCourseByIdService, updateCourseService } from "../models/courseModel.js";
...
export const getAllCourses = async(req, res, next)=>{
    try{
        ...
        handleResponse(res, 201, "course created", courses)
    }catch(err){
        next(err);
    }
}
