import {createCoursePayedService } from "../models/coursePayedModel.js";
...
export const createCoursePayed = async(req, res, next)=>{
    const { id_course, id_user, id_pago} = req.body;
    try{
        const newCourse = await createCoursePayedService(id_course, id_user, id_pago);
